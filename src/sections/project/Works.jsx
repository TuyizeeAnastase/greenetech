...
class Works extends Component{
    render(){
        return (
            <div class="py-3 border-bottom" style={{marginBottom:'12rem'}} id="features">
            <div class="container px-5 my-5">
                <div class="row gx-5">
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <div class="feature  bg-gradient w-10 h-10 text-white rounded-3 mb-3" style={{backgroundColor:'rgb(12, 51, 30)'}}><i class="fa fa-car" aria-hidden="true" style={{marginLeft:'12px',marginTop:'8px',height:'40px',width:'40px'}}></i></div>
                        ...
                        <a class="text-decoration-none " style={{color:'seagreen',fontWeight:'800'}} href="#!">
                            Call to action
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <div class="feature bg-gradient w-10 h-10 text-white rounded-3 mb-3" style={{backgroundColor:'rgb(12, 51, 30)'}}>
                            <i class="fa fa-money" aria-hidden="true" style={{marginLeft:'12px',marginTop:'8px',height:'40px',width:'40px'}}></i></div>
                    ...
                    <div class="col-lg-4">
                        <div class="feature  bg-gradient w-10 h-10 text-white rounded-3 mb-3" style={{backgroundColor:'rgb(12, 51, 30)'}}><i class="fa fa-cog" aria-hidden="true" style={{marginLeft:'12px',marginTop:'8px',height:'40px',width:'40px'}}></i></div>
